...
public interface ElectronicsService{
	 ...
	 * @throws AuthenticationNotSupportedException 
	   * */
	    void delete(String modelNum, String password, String saveDir) throws SQLException, AuthenticationNotSupportedException;
	 ...
	 * @throws AuthenticationNotSupportedException 
	   * */
	   void update(Electronics electronics) throws SQLException, AuthenticationNotSupportedException;
