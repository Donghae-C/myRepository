...
public class MenuView {
	...
	public void printMenu() {
		...
		while (true) {
			System.out.println("----------------------------------------------------------------------------------");
			System.out.println("1. 전체검색    2. 모델번호검색     3.등록     4. 수정   5. 삭제   6.가격기준정렬  7.이름기준정렬 8.특정가격 이하 검색 9. 종료");
			System.out.println("----------------------------------------------------------------------------------");
	 ...
	 */
	public void inputInsert() throws NumberFormatException{
	 ...
	 */
	public void inputSearch() throws NumberFormatException{
	...
	public void inputSearchPrice() {
		System.out.println("기준 가격은?");
		int price = Integer.parseInt(sc.nextLine());
		controller.selectUnderPrice(price);
	}
