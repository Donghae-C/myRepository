...
/**
 * 전공별 학생 수 구하기 (collect + groupingBy) List<Student>에서 전공별 학생 수를 구하시오.
 */
public class Test04 {
	public static void main(String[] args) {
		...
		Map<String, Long> collect = students.stream().collect(Collectors.groupingBy(Student::getMajor, Collectors.counting()));
