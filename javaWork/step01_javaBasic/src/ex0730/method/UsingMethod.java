...
class UsingMethodExam{
	...
	*/	
	public String methodExam03_02(String str, int a) {
		...
		System.out.println(methodExam03_01(a));
	...
	*/	
	protected double methodExam03_04(int a, double b, int c) {
		...
		MakeMethodExam02 methodExam = new MakeMethodExam02();
		
		return methodExam.methodExam02_04(a, b, c);
	}
	
	//test
	public int getPrivateMethod(int a) {
	
		return methodExam03_01(a);
	}
...
class UsingMethod{
	...
	public static void main(String[] args) {
		...
		System.out.println(ume.methodExam03_02("흠..", 5));
		ume.methodExam03_03(3, "이건");
		System.out.println(ume.methodExam03_04(3, 5.2, 5));
		ume.getPrivateMethod(5);
